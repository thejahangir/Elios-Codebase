...
const SapErpServicePage = () => {
  const data = {
    ...
    overviewDescription: "We understand the current market scenario. To run a business in a competitive environment, it is necessary to stay updated with well-defined techniques and procedures to handle it. With our years of deep-dive module-level experience in various industries, our team is well-versed in providing exact solutions for maximum efficiency.\n\nBusinesses are always on the lookout for skilled resources and to match their requirements, you can rely on us.\n\nConnect with us to acquire and unlock world-class SAP/ERP implementation that drives business.",
    overviewImage: defaultOverviewBg,
    featuresHeading: "Our Capabilities",
    features: [
      { 
        title: "SAP Staffing Solutions", 
        description: "Our staffing solutions include contract staffing, full-time work opportunities, contract-to-hire solutions, etc. to match your business requirements.", 
        icon: <Users /> 
      },
      { 
        title: "Latest SAP Versions", 
        description: "Our experts are ever-ready to provide solutions in the latest versions of SAP that include ECC 6.0, R/3, All in One, Business By Design, and other versions.", 
        icon: <Database /> 
      },
      { 
        title: "Industry Experience", 
        description: "Deep-dive module-level experience across various industries providing exact solutions for maximum efficiency.", 
        icon: <Building /> 
      }
    ]
  };
